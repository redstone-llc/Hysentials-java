...
import llc.redstone.hysentials.htsl.loaders.*;
...
public class Cluster {
    ...
    public void loadActions(List<Object[]> loaders) {
        for (Object[] action : loaders) {
            ...
            sequence.add(Loader.LoaderObject.setActionName(loader.name));
            ...
            sequence.add(Loader.LoaderObject.returnToEditActions());
