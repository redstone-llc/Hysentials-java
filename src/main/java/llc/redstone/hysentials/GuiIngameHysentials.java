...
public class GuiIngameHysentials extends GuiIngame
{
    ...
    private GuiOnlineList hysentialsOnlineList;

    public GuiIngameHysentials(Minecraft mc)
    {
        super(mc);
        debugOverlay = new GuiOverlayDebugForge(mc);
        hysentialsOnlineList = new GuiOnlineList();
    }
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (!renderHysentialsPlayerList(width, height)) renderPlayerList(width, height);
