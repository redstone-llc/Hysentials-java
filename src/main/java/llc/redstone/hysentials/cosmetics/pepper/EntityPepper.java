...
public class EntityPepper extends EntityTameable {
    EntityArmorStand armorStand;
    public String ownerName;
    public EntityPepper(World worldIn, String name) {
        super(worldIn);
        setSize(0.6F, 1F);
        ...
        armorStand.setCustomNameTag(C.AQUA + name + "'s Pepper Companion");
        armorStand.setPosition(posX, posY - 1.2, posZ);
        worldIn.spawnEntityInWorld(armorStand);
    }

    static {
        EntityList.addMapping(EntityPepper.class, "Pepper", 202, (int) Renderer.color(147,138,130), (int) Renderer.color(89,75,72));
    }
