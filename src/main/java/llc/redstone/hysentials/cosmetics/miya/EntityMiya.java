...
public class EntityMiya extends EntityTameable {
    EntityArmorStand armorStand;
    public String ownerName;
    public EntityMiya(World worldIn, String name) {
        super(worldIn);
        setSize(0.6F, 1F);
        ...
        setTamed(true);
        setCustomNameTag(C.AQUA + name + "'s Miya Companion");
        ...
        armorStand.setCustomNameTag(C.AQUA + name + "'s Miya Companion");
        armorStand.setPosition(posX, posY - 1.2, posZ);
        worldIn.spawnEntityInWorld(armorStand);
    }

    static {
        EntityList.addMapping(EntityMiya.class, "Miya", 204, 0xefefe8, 0xc96f42);
    }
