...
public class EntityCubit extends EntityTameable {
    ...
    public EntityCubit(World worldIn, String name) {
        ...
        ownerName = name;
        this.armorStand = new EntityArmorStand(this.worldObj);
        this.armorStand.setInvisible(true);
        this.armorStand.noClip = true;
        this.armorStand.setAlwaysRenderNameTag(true);
        this.armorStand.setCustomNameTag(C.AQUA + name + "'s Cubit Companion");
        this.armorStand.setPosition(posX, posY - 1.2, posZ);
        worldIn.spawnEntityInWorld(this.armorStand);
    }
