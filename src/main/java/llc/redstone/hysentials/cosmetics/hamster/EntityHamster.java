...
public class EntityHamster extends EntityTameable {
    ...
    public EntityHamster(World worldIn, String name) {
        super(worldIn);
        setSize(0.4F, 0.2F);
        ...
        armorStand.setCustomNameTag(C.AQUA + name + "'s Hamster Companion");
    ...
    static {
        EntityList.addMapping(EntityCubit.class, "Hamster", 203, (int) Renderer.color(192,147,89), (int) Renderer.color(112,76,29));
    }
