...
public class SplashProgress {
    ...
    public static void drawSplash(TextureManager tm) {
        ...
        if (splash == null) splash = new ResourceLocation("textures/hysentials-splash.png");

        // Bind the texture
        if (tm == null) tm = Minecraft.getMinecraft().getTextureManager();
    ...
    private static void drawProgress() {
        ...
        if (raleway == null) raleway = new HysentialsFontRenderer("Raleway", 20);
        if (roboto == null) roboto = new HysentialsFontRenderer("Roboto", 20);
