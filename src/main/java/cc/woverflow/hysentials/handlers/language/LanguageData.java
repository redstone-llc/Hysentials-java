 ...
 */package cc.woverflow.hysentials.handlers.language;
...
public class LanguageData {
    ...
    //Most Complicated Regexes ever!
    private String rankedPlayerChat = "(?<pprefix>§r.*)(?<prefix>§[0-9a-fk-or]\\[.*] |§7)(?<name>.*)(?:§f|§7): ";
    private String rankedInChat = "(?<pprefix>.*§r.*)(?<prefix>§[0-9a-fk-or]\\[.*] |§7)(?<name>.*)(?:§r§f|§r§7)(?<afterName>.+)";
    ...
    public Pattern rankedPlayerChatRegex;
    public Pattern rankedInChatRegex;
    ...
    public void initialize() {
        if (!hasInitialized) {
            ...
            rankedPlayerChatRegex = Pattern.compile(rankedPlayerChat);
            rankedInChatRegex = Pattern.compile(rankedInChat);
        }
